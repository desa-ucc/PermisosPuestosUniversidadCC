...
// Replace the HTML table and form sections
// We can just regex replace everything inside template: \` ... \` using a new template.
const templateStart = code.indexOf('template: `');
const templateEnd = code.indexOf('`', templateStart + 11);
...
code = code.substring(0, templateStart + 10) + newTemplate + code.substring(templateEnd + 1);

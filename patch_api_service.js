...
if (!code.includes('import { Puesto, Empleado, HardwareIdeal, HardwareAsignado, SoftwareLocal, PermisoSitio, Plataforma, Catalogo, CatalogoTipoHardware, Usuario, Permiso, ReportePerfil, ReporteHardware, ReporteSitio, ReportePlataforma, Rol, AccesoBD }')) {
    code = code.replace(
